...
- Step 1: Prepare your environment.
  ...
  In addition to Hadoop and Hive, before you begin ensure ```gcc, unzip, java-devel``` are installed and available on your system path. If you system does not have it, install it using yum or apt-get.
